...
public class TileTests {
    ...
    public void testPrintDeck(){
        ...
        Tile[] tilePile = new Tile [48];
            ...
            //printing the tilePile
        for(int i = 0; i < 48; i++) {
            System.out.println("TILE " + (i + 1) + "!!!");
            if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.LAKE) {
                System.out.println("TOP is LAKE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.JUNGLE) {
                System.out.println("TOP is JUNGLE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.ROCKY) {
                System.out.println("TOP is ROCKY");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.VOLCANO) {
                System.out.println("TOP is VOLCANO");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.GRASSLANDS) {
                System.out.println("TOP is GRASSLANDS");
            }
            if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.LAKE) {
                System.out.println("LEFT is LAKE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.JUNGLE) {
                System.out.println("LEFT is JUNGLE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.ROCKY) {
                System.out.println("LEFT is ROCKY");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.VOLCANO) {
                System.out.println("LEFT is VOLCANO");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.GRASSLANDS) {
                System.out.println("LEFT is GRASSLANDS");
            }
            if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.LAKE) {
                System.out.println("RIGHT is LAKE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.JUNGLE) {
                System.out.println("RIGHT is JUNGLE");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.ROCKY) {
                System.out.println("RIGHT is ROCKY");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.VOLCANO) {
                System.out.println("RIGHT is VOLCANO");
            } else if (tilePile[i].getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.GRASSLANDS) {
        ...
        for (int i = 0; i<48; i++) {
            ...
            //pushing all of the now randomized tiles onto the Deck
            for(int i = 0; i < 48; i++) {
                Deck.add(tilePile[i]);
            }
        System.out.println();
        System.out.println("===========================");
        System.out.println("PRINTING SHUFFLED DECK NOW");
        System.out.println("===========================");
        System.out.println();
        //Deck.printDeck();
        for(int i = 0; i < 48; i++) {
            System.out.println("TILE " + (i+1) + "!!!");
            if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.LAKE){
                System.out.println("TOP is LAKE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.JUNGLE){
                System.out.println("TOP is JUNGLE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.ROCKY){
                System.out.println("TOP is ROCKY");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.VOLCANO){
                System.out.println("TOP is VOLCANO");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.TOP) == TerrainType.GRASSLANDS) {
                System.out.println("TOP is GRASSLANDS");
            }
            if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.LAKE){
                System.out.println("LEFT is LAKE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.JUNGLE){
                System.out.println("LEFT is JUNGLE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.ROCKY){
                System.out.println("LEFT is ROCKY");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.VOLCANO){
                System.out.println("LEFT is VOLCANO");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.LEFT) == TerrainType.GRASSLANDS) {
                System.out.println("LEDT is GRASSLANDS");
            }
            if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.LAKE){
                System.out.println("RIGHT is LAKE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.JUNGLE){
                System.out.println("RIGHT is JUNGLE");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.ROCKY){
                System.out.println("RIGHT is ROCKY");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.VOLCANO){
                System.out.println("RIGHT is VOLCANO");
            }
            else if(Deck.get(i).getTerrainTypeForPosition(HexagonPosition.RIGHT) == TerrainType.GRASSLANDS) {
                System.out.println("RIGHT is GRASSLANDS");
            }
        }
